...
## Видеоматериалы:
   https://vkvideo.ru/video421331757_456239270
...
## Основные возможности:
  ...
  - Управление ролями
  - Просмотр удобной таблицы посещаемости: прокрутка данных с фиксированной шапкой для читаемости.
...
## Обоснование выбора технологий:
 ...
 ### JAVASCRIPT:
 **Почему выбрали:**
- **Автоматическое управление памятью** — JVM автоматически освобождает память, занимаемую объектами, которые больше не используются, снижая риск утечек памяти.  
...
## Инициализация данных:
  ...
  - Четыре основных аллергена: lactose (лактоза), eggs (яйца), fish (рыба), gluten (глютен)  
